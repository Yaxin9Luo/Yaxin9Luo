...
Selected projects I lead or contribute to have received **649 GitHub stars** and **41 forks** across **4** personal and organization repositories.
...
| --- | ---: | ---: | --- |
| [VILA-Lab/FigMirror](https://github.com/VILA-Lab/FigMirror) | 497 | 35 | Automated plotting from paper figure styles. |
...
<sub>Last updated: 2026-08-05. Managed from [data/research-repos.json](data/research-repos.json).</sub>
<!-- RESEARCH-IMPACT:END -->
