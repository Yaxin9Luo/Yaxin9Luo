...
<p align="center">
  <img src="https://img.shields.io/badge/research%20code%20stars-640-00D4FF?style=for-the-badge&labelColor=0B1221" alt="Research code stars"/>
...
Selected projects I lead or contribute to have received **640 GitHub stars** and **40 forks** across **4** personal and organization repositories.
...
| --- | ---: | ---: | --- |
| [VILA-Lab/FigMirror](https://github.com/VILA-Lab/FigMirror) | 493 | 35 | Automated plotting from paper figure styles. |
| [MetaAgentX/OpenCaptchaWorld](https://github.com/MetaAgentX/OpenCaptchaWorld) | 81 | 3 | Web-based benchmark and platform for evaluating multimodal LLM agents. |
...
<sub>Last updated: 2026-07-16. Managed from [data/research-repos.json](data/research-repos.json).</sub>
<!-- RESEARCH-IMPACT:END -->
