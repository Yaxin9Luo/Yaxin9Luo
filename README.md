...
<p align="center">
  <img src="https://img.shields.io/badge/research%20code%20stars-902-00D4FF?style=for-the-badge&labelColor=0B1221" alt="Research code stars"/>
...
Selected projects I lead or contribute to have received **902 GitHub stars** and **55 forks** across **5** personal and organization repositories.
...
| --- | ---: | ---: | --- |
| [VILA-Lab/FigMirror](https://github.com/VILA-Lab/FigMirror) | 516 | 38 | Automated plotting from paper figure styles. |
| [Yaxin9Luo/AutoDesign](https://github.com/Yaxin9Luo/AutoDesign) | 225 | 10 | Open-source design agent and harness for producing editable academic posters, slides, webpages, and videos. |
| [MetaAgentX/OpenCaptchaWorld](https://github.com/MetaAgentX/OpenCaptchaWorld) | 91 | 4 | Web-based benchmark and platform for evaluating multimodal LLM agents. |
...
<sub>Last updated: 2026-09-23. Managed from [data/research-repos.json](data/research-repos.json).</sub>
<!-- RESEARCH-IMPACT:END -->
