...
Selected projects I lead or contribute to have received **650 GitHub stars** and **40 forks** across **4** personal and organization repositories.
...
| --- | ---: | ---: | --- |
| [VILA-Lab/FigMirror](https://github.com/VILA-Lab/FigMirror) | 498 | 34 | Automated plotting from paper figure styles. |
...
<sub>Last updated: 2026-08-04. Managed from [data/research-repos.json](data/research-repos.json).</sub>
<!-- RESEARCH-IMPACT:END -->
