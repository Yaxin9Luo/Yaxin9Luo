...
Selected projects I lead or contribute to have received **618 GitHub stars** and **37 forks** across **4** personal and organization repositories.
...
| --- | ---: | ---: | --- |
| [VILA-Lab/FigMirror](https://github.com/VILA-Lab/FigMirror) | 478 | 32 | Automated plotting from paper figure styles. |
...
<sub>Last updated: 2026-06-22. Managed from [data/research-repos.json](data/research-repos.json).</sub>
<!-- RESEARCH-IMPACT:END -->
