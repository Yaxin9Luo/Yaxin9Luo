...
Selected projects I lead or contribute to have received **633 GitHub stars** and **38 forks** across **4** personal and organization repositories.
...
| --- | ---: | ---: | --- |
| [VILA-Lab/FigMirror](https://github.com/VILA-Lab/FigMirror) | 489 | 33 | Automated plotting from paper figure styles. |
...
<sub>Last updated: 2026-06-30. Managed from [data/research-repos.json](data/research-repos.json).</sub>
<!-- RESEARCH-IMPACT:END -->
