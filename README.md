...
<p align="center">
  <img src="https://img.shields.io/badge/research%20code%20stars-652-00D4FF?style=for-the-badge&labelColor=0B1221" alt="Research code stars"/>
...
Selected projects I lead or contribute to have received **652 GitHub stars** and **41 forks** across **4** personal and organization repositories.
...
| --- | ---: | ---: | --- |
| [VILA-Lab/FigMirror](https://github.com/VILA-Lab/FigMirror) | 499 | 35 | Automated plotting from paper figure styles. |
| [MetaAgentX/OpenCaptchaWorld](https://github.com/MetaAgentX/OpenCaptchaWorld) | 85 | 4 | Web-based benchmark and platform for evaluating multimodal LLM agents. |
...
<sub>Last updated: 2026-08-12. Managed from [data/research-repos.json](data/research-repos.json).</sub>
<!-- RESEARCH-IMPACT:END -->
